...
#define CS2FOW_AVX
		...
		CS2FOW_AVX uint32_t hit_packet(const triangle_packet8& packet, uint32_t count, vec3 origin, vec3 direction)
		{
			...
			const __m256 u =
				_mm256_mul_ps(_mm256_add_ps(_mm256_add_ps(_mm256_mul_ps(tx, px), _mm256_mul_ps(ty, py)), _mm256_mul_ps(tz, pz)), inv_det);
			...
			const __m256 v =
				_mm256_mul_ps(_mm256_add_ps(_mm256_add_ps(_mm256_mul_ps(dx, qx), _mm256_mul_ps(dy, qy)), _mm256_mul_ps(dz, qz)), inv_det);
			...
			const __m256 distance =
				_mm256_mul_ps(_mm256_add_ps(_mm256_add_ps(_mm256_mul_ps(e2x, qx), _mm256_mul_ps(e2y, qy)), _mm256_mul_ps(e2z, qz)), inv_det);
