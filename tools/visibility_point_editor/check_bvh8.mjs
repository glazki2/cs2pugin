...
assert.equal(shoulder_offset(0, {}, false), 32);
assert.equal(shoulder_offset(200, {}, false), 160);
assert.equal(shoulder_offset(300, {}, false), 224);
assert.equal(shoulder_offset(0, {}, true), 64);
assert.equal(shoulder_offset(200, {}, true), 192);
assert.equal(shoulder_offset(300, {}, true), 256);
...
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {}})[1].y, 32);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {a: true}})[1].y, 64);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {a: true}})[2].y, -32);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {d: true}})[1].y, 32);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {d: true}})[2].y, -64);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {w: true}})[1].y, 32);
assert.equal(runtime_origins(map, {origin: {x: -10, y: 0, z: 0}, yaw: 0, pingMs: 0, buttons: {w: true}})[2].y, -32);
